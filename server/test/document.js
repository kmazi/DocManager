...
import app from '../app';
import { testUser, testUser1, superAdmin, admin }
from '../mocks/users';
...
describe('Document controllers:', () => {
  ...
  describe('Creating Document', () => {
    ...
    title`, (done) => {
      ...
      .end((err, res) => {
        ...
        .equal('Empty title or body or access field!');
        done();
      });
    });
  ...
  describe('Finding a document', () => {
    ...
    it('should allow a superadmin user to access a private document',
    (done) => {
      request(app).get(`/api/v1/document/${userDocument.docId}`)
  ...
  describe('Deleting a document', () => {
    ...
    it(`should deny random users access except admin from deleting
     another users document`, (done) => {
      request(app).post('/api/v1/users')
      .send(testUser1).end((err, res1) => {
  ...
  describe('search function', () => {
   ...
   (done) => {
    ...
    through documents accessible to them`,
    (done) => {
      request(app)
